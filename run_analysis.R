...
# IN ORDER TO RUN YOURSELF, PLEASE SET YOUR WORKING DIRECTORY TO THE DATASET DIRECTORY e.g.:
...
# This commented out version will not include separate mean()-x, mean()-y, and mean()-z vars
